...
Main = (function() {
  ...
  Main.prototype.getShareUrl = function() {
    var _url;
    _url = (this.ORIGIN_URL + "?lat=" + (this.map.getCenter().lat())) + ("&lng=" + (this.map.getCenter().lng()) + "&heading=" + this.sv.pov.heading);
    return _url;
  };
  ...
  Main.prototype.render = function(latLng) {
    ...
    window.initMap = (function(_this) {
      return function() {
        if (location.search.match("lat")) {
          return _this.render(new window.google.maps.LatLng(location.search.match(/\?lat=(.*?)\&/)[1], location.search.match(/(\&|＆)lng=(.*?)$/)[2]));
        } else {
