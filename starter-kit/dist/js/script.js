...
Main = (function() {
  function Main() {
    this.ORIGIN_URL = "http://gonshi.github.io/marigan/";
  ...
  Main.prototype.setSocial = function() {
    ...
    this.social_btns.facebook.addEventListener("click", (function(_this) {
      return function() {
        return FB.ui({
          method: "share",
          href: encodeURIComponent(_this.url)
        });
      };
    })(this));
    this.social_btns.tweet.addEventListener("click", (function(_this) {
      return function() {
        return _this.popup(("http://twitter.com/share?url=" + (encodeURIComponent(_this.url)) + "&text=") + ((encodeURIComponent("万里眼は、Chromeで新規タブを開く度に地球上のランダムな" + "位置のストリートビューを観ることができるChrome拡張です。")) + "&hashtags=万里眼"));
      };
    })(this));
    this.social_btns.hatena.addEventListener("click", (function(_this) {
      return function() {
        return _this.popup("http://b.hatena.ne.jp/add?url=" + (encodeURIComponent(_this.url)) + "&title=" + (encodeURIComponent("万里眼")));
      };
    })(this));
    return this.social_btns.gplus.addEventListener("click", (function(_this) {
      return function() {
        return _this.popup("https://plus.google.com/share?url=" + (encodeURIComponent(_this.url)));
      };
    })(this));
  };
  ...
  Main.prototype.render = function(latLng) {
    ...
    this.url = this.ORIGIN_URL + "?lat=" + (_map.getCenter().lat()) + "&lng=" + (_map.getCenter().lng());
    this.social_txt.setAttribute("value", this.url);
    ...
    this.social_btns.link.addEventListener("click", (function(_this) {
      return function() {
        ...
        if (_this.social_btns.link.getAttribute("class").match("is_active")) {
          ...
          _this.social_btns.link.innerHTML = _this.url;
